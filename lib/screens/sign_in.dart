...
class SignInState extends State<SignIn>  {
  ...
  bool _issecure = true; // password k liye h 
...
final TextEditingController _emailController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      await FirebaseAuth.instance.signInWithCredential(Credential);
       Navigator.pushNamedAndRemoveUntil(context, 'Getting_Started', (route) => false);
  ...
  //     await FirebaseAuth.instance.signOut();  // google k liye 
  //   }
  //   // if (SignIn.isLoginwith == true) {
      ...
      if (user != null) {
        setState(() async{
          ...
          final user = await FirebaseAuth.instance.currentUser;
            var userID = user!.uid;
            var ab = await FirebaseFirestore.instance
            .collection('Users')
            .doc(userID)
            .get();
            if(ab.data() != null){
