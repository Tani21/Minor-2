...
Squatsfunc() async {
  ...
  await DatabaseService().Squatsfunc(Squatsinfo).then((value) {
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  Squatsfunc();
                 // pushUp();
                  Navigator.pushReplacementNamed(context, 'VideoAssessmentRunTest');
                },
