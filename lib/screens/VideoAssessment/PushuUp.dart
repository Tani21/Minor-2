...
pushUp() async {
  ...
  await DatabaseService().pushUp(pushUpinfo).then((value) {
                  ...
                  child: TextFormField(
                    style: TextStyle(
                        ...
                        setState(() {
                             ...
                             VideoAssessmentPushUp.number_pushUp = value;
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacementNamed(context, 'VideoAssessmentSquats');
                },
