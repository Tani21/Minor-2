...
class _SpotJogState extends State<SpotJog> {
  ...
  //         'https://tenor.com/view/running-spot-jog-jogging-exercise-physical-education-gif-22164209');
  //     //network(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Image.asset('assets/assessment/running-spot-jog.gif',  height: size.height * 0.35,
            width: size.width * 0.9,)
                ],
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  ...
                  // Navigator.push(context,MaterialPageRoute(builder: (BuildContext context) => CrossToeTouch(),),);
                  // Navigator.pushReplacement(context,new MaterialPageRoute(builder: (BuildContext context) => new CrossToeTouch()));
