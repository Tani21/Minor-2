...
class _CrossToeTouchState extends State<CrossToeTouch> {
  ...
  //          _video_controller = VideoPlayerController.asset(
  //         'assets/gifs/3.gif');
  //     //network(
  //     //   'https://flutter.github.io/assets-for-api-docs/assets/videos/butterfly.mp4',
  //     // );
          ...
          CircleAvatar(
            ...
            child: IconButton(
              onPressed: () {
                ...
                // Navigator.push(context,MaterialPageRoute(builder: (BuildContext context) => ShoulderRotation(),),);
                // Navigator.of(context).pushNamedAndRemoveUntil('ShoulderRotation', ModalRoute.withName('PreRequisite'));
                // Navigator.pushReplacement(context,new MaterialPageRoute(builder: (BuildContext context) => new ShoulderRotation()));
