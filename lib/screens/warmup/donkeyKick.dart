        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Image.asset('assets/Gifs/donkey_kicks.gif',  height: size.height * 0.35,
            width: size.width * 0.9,)
                ],
            ...
            FloatingActionButton.extended(
              onPressed: () {
                ...
                // Navigator.pushReplacement(context,new MaterialPageRoute(builder: (BuildContext context) => new VideoAssessmentBalance()));
