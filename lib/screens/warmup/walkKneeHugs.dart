        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Image.asset('assets/Gifs/walkingkneehug.gif',  height: size.height * 0.35,
            width: size.width * 0.9,)
                ],
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  ...
                  // Navigator.pushReplacement(context,new MaterialPageRoute(builder: (BuildContext context) => new WalkingHip()));
